...
cv.Save("IntrinsicsLeft.xml",intrinsic_matrix)
cv.Save("DistortionLeft.xml",distortion_coefficient)
cv.Save("objectPtsLeft.xml",object_points2)
cv.Save("imagePtsLeft.xml",image_points2)
cv.Save("numPointsLeft.xml",point_counts2)
# Loading from xml files
intrinsic = cv.Load("IntrinsicsLeft.xml")
distortion = cv.Load("DistortionLeft.xml")
